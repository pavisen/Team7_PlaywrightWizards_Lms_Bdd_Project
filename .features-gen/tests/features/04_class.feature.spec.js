...
test.describe('Class Page Validation', () => {
  ...
  test('Check if the mandatory fields are updated with valid data', { tag: ['@class', '@doing'] }, async ({ Given, commonFunctions, classPage, When, testData, page, Then }) => { 
    await Given('Admin is on the Edit Class Popup window', null, { commonFunctions, classPage }); 
