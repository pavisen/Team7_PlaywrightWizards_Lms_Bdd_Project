...
test.describe('Batch Module -Batch Page Navigation', () => {
  ...
  test('Verify Admin Add Batch successfully', { tag: ['@smoke'] }, async ({ Given, loggedInPage, When, batchPage, commonFunctions, testData, Then }) => { 
  ...
  test('Validate search box functionality', { tag: ['@smoke'] }, async ({ Given, commonFunctions, When, Then }) => { 
    await Given('Admin is on the batch page', null, { commonFunctions }); 
