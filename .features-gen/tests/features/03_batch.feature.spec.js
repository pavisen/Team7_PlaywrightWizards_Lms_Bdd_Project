...
test.describe('Batch Module -Batch Page Navigation', () => {
  ...
  test('Verify Admin Navigate to Batch page successfully', { tag: ['@BatchPageNavigation', '@smoke'] }, async ({ When, commonFunctions, Then }) => { 
  ...
  test('Validate search box functionality', { tag: ['@BatchEdit', '@smoke'] }, async ({ Given, commonFunctions, When, Then }) => { 
    await Given('Admin is on the batch page', null, { commonFunctions }); 
  ...
  test('validate save button in Batch details pop up in Batch Page', { tag: ['@BatchEdit', '@smoke'] }, async ({ Given, commonFunctions, When, batchPage, Then }) => { 
    await Given('Admin is on the Batch Details Page', null, { commonFunctions }); 
