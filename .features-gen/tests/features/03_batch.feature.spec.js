...
test.describe('Batch Module -Batch Page Navigation', () => {
  ...
  test('Validate single row delete with checkbox', { tag: ['@Delete'] }, async ({ Given, paginationPage, commonFunctions, When, Then }) => { 
    ...
    await Then('The respective row in the table should be deleted', null, { commonFunctions }); 
  });

  test('Validate multiple row delete with checkbox', { tag: ['@Delete1'] }, async ({ Given, paginationPage, commonFunctions, When, Then }) => { 
    await Given('Admin is on the batch Page', null, { paginationPage, commonFunctions }); 
    await When('Admin clicks on the delete icon under the Manage batch header', null, { commonFunctions }); 
    await Then('The respective row in the table should be deleted', null, { commonFunctions }); 
  });
...
const bddFileData = [ // bdd-data-start
  ...
  {"pwTestLine":74,"pickleLine":80,"tags":["@Delete1"],"steps":[{"pwStepLine":7,"gherkinStepLine":5,"keywordType":"Context","textWithKeyword":"Given Admin is on the home page after Login","isBg":true,"stepMatchArguments":[]},{"pwStepLine":75,"gherkinStepLine":81,"keywordType":"Context","textWithKeyword":"Given Admin is on the batch Page","stepMatchArguments":[]},{"pwStepLine":76,"gherkinStepLine":82,"keywordType":"Action","textWithKeyword":"When Admin clicks on the delete icon under the Manage batch header","stepMatchArguments":[]},{"pwStepLine":77,"gherkinStepLine":83,"keywordType":"Outcome","textWithKeyword":"Then The respective row in the table should be deleted","stepMatchArguments":[]}]},
