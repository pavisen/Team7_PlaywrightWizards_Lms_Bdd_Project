...
test.describe('Batch Module -Batch Page Navigation', () => {
  ...
  test('Validate batch name  value is disabled to edit in Batch Page', { tag: ['@BatchEditbb'] }, async ({ Given, commonFunctions, When, batchPage, Then }) => { 
    await Given('Admin is on the Batch page', null, { commonFunctions }); 
