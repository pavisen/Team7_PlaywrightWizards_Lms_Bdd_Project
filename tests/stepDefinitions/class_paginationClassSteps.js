...
When(
  "Admin clicks Next page link on the class table",
...
Then(
  "Admin should see the next page record on the table  with Pagination has next active link enabled",
  async ({ commonFunctions }) => {
...
Then(
  "Admin should see the last page record on the table with Next page link are disabled",
  async ({ commonFunctions }) => {
...
Then(
  "Admin should see the previous page record on the table with pagination has previous page link enabled",
  async ({ commonFunctions }) => {
...
Then(
  "Admin should see the very first page record on the table with Previous page link are disabled",
  async ({ commonFunctions }) => {
