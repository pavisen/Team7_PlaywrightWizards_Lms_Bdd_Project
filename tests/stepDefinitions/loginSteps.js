...
When(
  "Admin enter invalid data and clicks login button",
  async ({ loginPage }) => {
...
Then(
  "Error message {string} for null user name",
  async ({ loginPage }, expectedErrorMessage) => {
...
Then(
  "Error message {string} for null password",
  async ({ loginPage }, expectedErrorMessage) => {
...
Then(
  "Admin should {string} in the second text field",
  async ({ loginPage }, expectedText) => {
...
When(
  "Admin enter invalid URL and clicks login button",
  async ({ loginPage }) => {
...
When(
  "Admin gives the correct LMS portal HTTP response greater than {int}",
  async ({ loginPage }, arg) => {
...
Then(
  "Admin should see the correct spelling in all fields",
  async ({ loginPage }) => {
...
Then(
  "Admin should see LMS - Learning Management System",
  async ({ loginPage, commonFunctions }) => {
...
Then(
  ...
  async ({ loginPage }, expectedText) => {
    const firstFieldText = await loginPage.usernameInput.getAttribute(
