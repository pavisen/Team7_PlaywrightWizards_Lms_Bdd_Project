...
Given(
  "Admin is on the program page for delete",
...
When(
  "Admin clicks on the delete icon under the Manage program header",
...
When(
  "Admin clicks on the delete icon under the Manage program header for multiple rows",
  async ({ programPage, commonFunctions }) => {
...
Then(
  "The respective row in the program table should be deleted",
  async ({ programPage, commonFunctions }) => {
...
Then(
  "The respective multiple rows in the program table should be deleted",
  async ({ programPage, commonFunctions }) => {
    const successMessage =
      await programPage.programdeletedMessage.textContent();
